	...
	public void addInformation(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
		...
		if (data.getProgram().isEmpty()) {
			...
			if (!program_name.isEmpty()) {
				tooltip.add(new TranslationTextComponent("item.minecoprocessors.code_book.tooltip.program", program_name));
			}
			tooltip.add(new TranslationTextComponent("item.minecoprocessors.code_book.tooltip.numpages", String.format("%d", data.getPageCount())));
			tooltip.add(new TranslationTextComponent("item.minecoprocessors.code_book.tooltip"));
		}
	}
